...
# 
# In this case, like in the simulations section, we will follow a 3D approach, we manage the data using Spatial+Spectral data, rather than 1D, using only spectral. for more details about these aproaches check epigraph Dataset above, since the procedure is the same. Hence, the steps to follow are:
# 
